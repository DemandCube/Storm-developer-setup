...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.define :storm1 do |storm1|
    # Create a private network, which allows host-only access to the machine
    # using a specific IP.
    storm1.vm.network :private_network, ip: "192.168.57.10"
    storm1.vm.hostname = "storm1.local"
  ...
  # the file base-centos.pp in the manifests_path directory.
  #
